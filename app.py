...
def ana_uygulama_goster():
    ...
    with t1: # PLANLA
        ...
        with c1:
            ...
            p3 = st.checkbox("Etkinlik türü netleşti mi?")
            p4 = st.checkbox("Kazanımlar/beklenen çıktılar yazıldı mı?")
            st.subheader("2. Paydaş ve Konuşmacı Planlaması")
            p5 = st.checkbox("Konuşmacı ve işveren kurumu belli mi?")
            p6 = st.checkbox("REsmi davet gönderildi")
            p7 = st.checkbox("Konuşmacı Özgeçmişi/etkinlik özeti alındı")
            p8 = st.checkbox("Konuşmacı ihityaçları planlandı")
        with c2:
            st.subheader("3. Zaman/Mekan Kaynak Planlaması")
            p9 = st.checkbox("Tarih/Saat kesinleşti")
            p10 = st.checkbox("Salon/online platform rezervasyonu yapıldı ")
            p11 = st.checkbox("Etkinlik akış ve zaman yönetimi oluşturuldu")
            p12 = st.checkbox("İsim kaynağı görevlendirmeleri yapıldı")
            ...
            p17 = st.checkbox("Kapanış ve teşekkür gerçekleştirildi") # Teknik altına eklendi
    ...
    with t2: # KONTROL
        ...
        with c1:
            ...
            k4 = st.checkbox("Katılımcı memnuniyet anketi yapıldı")
        ...
        with c2:
            ...
            k8 = st.checkbox("Pyadaş geri bildirimleri analiz edildi iı?")
    ...
    with t3: # ÖNLEM
        ...
        with c1:
            ...
            o1 = st.checkbox("Eksik ve aksayanlar belirlendi")
            o2 = st.checkbox("Bir sonraki etkinlikler için iyileştirme öneriler yazıldı")
            o3 = st.checkbox("Planlama srüecinde değişiklik gereken noktalar belirlendi")
        with c2:
            st.subheader("2. Raporlama ve Arşiv")
            o4 = st.checkbox("Etkinlik raporu hazırlandı")
            o5 = st.checkbox("Fotoğraf ve haber metni paylaşıldı")
            o6 = st.checkbox("Tüm dökümanlar arşive eklendi")
        st.subheader("3. Sürdürülebilir İyiletirme")
        o7 = st.checkbox("Süreç değerlendirme toplnatısı yapıldı mı?")
